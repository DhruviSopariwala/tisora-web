...
const features = [
  {
    ...
    color: "#5F7A1F",
    bg: "rgba(95,122,31,0.05)",
    glow: "rgba(95,122,31,0.15)",
  },
  {
    icon: "💧",
  ...
  },
  {
    ...
    color: "#B23A2E",
    bg: "rgba(178,58,46,0.05)",
    glow: "rgba(178,58,46,0.2)",
  },
  {
    icon: "🍃",
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        border: "1px solid rgba(95,122,31,0.12)",
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-[#5F7A1F]/60 text-sm leading-relaxed">{feature.description}</p>
      </div>
    </motion.div>
  );
}
...
export default function WhySection() {
  ...
  return (
    <section
      ...
      style={{ background: "#FAF8F4", padding: "96px 0" }}
    >
        ...
        <svg width="100%" height="100%">
          <defs>
            <pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse">
              <path d="M 40 0 L 0 0 0 40" fill="none" stroke="#5F7A1F" strokeWidth="0.8" />
            </pattern>
          </defs>
      ...
      <div className="section-container relative z-10">
        ...
        >
          <motion.span
            className="inline-block text-[#AFC8A0] text-xs tracking-[0.45em] uppercase font-bold mb-4"
        ...
        >
          <div
            ...
            style={{
              background: "linear-gradient(135deg, #5F7A1F, #7A9B28)",
              padding: "28px 36px",
            }}
          >
            {/* Animated shimmer */}
            ...
            <div className="flex-1 text-center sm:text-left">
              <p className="text-[#FAF8F4] font-bold text-lg mb-1">
                Ready to experience the difference?
              </p>
              <p className="text-[#FAF8F4]/80 text-xs tracking-wider uppercase font-medium">
                HYTEA launches soon — be the first to know.
              </p>
            </div>
            <motion.button
              onClick={() => document.querySelector("#contact")?.scrollIntoView({ behavior: "smooth" })}
              className="flex-shrink-0 px-6 py-3 rounded-xl bg-[#F6D9A8] text-[#5F7A1F] text-sm font-bold uppercase tracking-widest shadow-lg"
