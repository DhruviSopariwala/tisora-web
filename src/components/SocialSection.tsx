...
const mockPosts = [
  { id: 1, emoji: "🍋", caption: "Lemon HYTEA — bright, zesty, electric. Coming soon. ✨", likes: "2.4k", bg: "linear-gradient(135deg, #FFFBEA, #FFF5C0)", border: "rgba(246,211,78,0.3)" },
  { id: 2, emoji: "🍑", caption: "Peach HYTEA — soft, juicy, warm. The golden hour in a can. 🧡", likes: "3.1k", bg: "linear-gradient(135deg, #FFF5EE, #FFE8D4)", border: "rgba(247,167,108,0.3)" },
  { id: 3, emoji: "🌿", caption: "Real tea. Real electrolytes. Real refreshment. #TISORA #HYTEA", likes: "1.8k", bg: "linear-gradient(135deg, #F0F7F0, #E4F0E4)", border: "rgba(169,195,162,0.3)" },
  { id: 4, emoji: "⚡", caption: "Hydration, reimagined. What does your body deserve? 💧", likes: "4.2k", bg: "linear-gradient(135deg, #F5EFE4, #EDE5D8)", border: "rgba(14,90,67,0.12)" },
  { id: 5, emoji: "🍵", caption: "Natural tea extracts. Khandsari sugar. Electrolytes. That's it. 🌾", likes: "2.9k", bg: "linear-gradient(135deg, #FFFBEA, #F5EFE4)", border: "rgba(182,139,94,0.25)" },
  { id: 6, emoji: "🌱", caption: "The wellness drink you've been waiting for. #HydrationReimagined", likes: "5.6k", bg: "linear-gradient(135deg, #F0F7F0, #E4F0E4)", border: "rgba(29,107,79,0.18)" },
];
  ...
  return (
    ...
    >
      ...
      <div className="section-container relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-14">
          {mockPosts.map((post, i) => (
            ...
            >
              ...
              {/* Hover overlay */}
              <div className="absolute inset-0 bg-[#0E5A43]/85 flex flex-col items-center justify-center gap-2 p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        ...
        >
          <p className="text-[#A9C3A2] text-xs tracking-[0.4em] uppercase mb-4">
            Join the Community
          </p>
          <h3
